...
In the `snp` dataset, there are 787 observations and 4 variables. In the
`unemployment` dataset, there are 810 observations and 3 variables.

The resulting dataset, `join`, contains 822 observations and 12
variables. The dimension of the resulting dataset is 822, 12. The range
