...
#### Description of the joined dataset
    ...
    There are 524 observations and 15 variables in the joined dataset. 
...
resulting dataset, `join`, contains 822 observations and 11 variables.
The dimension of the resulting dataset is 822, 11. The range of years is
between 1947 and 2015. The variables in the dataset include `president`,
`unemployment_rate`, and `close`.
